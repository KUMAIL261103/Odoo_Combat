    ...
    <div>
      <nav className="bg-slate-950  shadow-md py-4">
        <div className="container  mx-auto flex justify-between items-center">
          {/* Logo */}
          <div className="px-4 py-auto  text-2xl  font-bold text-white">
            Logoo
          </div>
          {/* Navigation Links */}
          ...
          {/* Login/Sigin */}
          <div className="px-5 py-auto text-xl flex items-center space-x-2 text-white">
            <button className="border px-6 border-light-green p-2 rounded-xl hover:bg-light-green hover:text-black">
              Sign In
            </button>
          </div>
        </div>
